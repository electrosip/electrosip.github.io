...
$(document).ready(function () {
	...
	$(".product_1 .color_selector > .swatch-color").on("click", function (e) {
		...
		if (color == "blue") {
			...
			$(".product_1 .product-featured-image").attr(
				"src",
				"assets/images/product/product_12.jpg"
			);
		} else {
		...
		if (color == "purple") {
			...
			$(".product_1 .product-featured-image").attr(
				"src",
				"assets/images/product/product_9.jpg"
			);
		} else {
	...
	$(".product_2 .color_selector > .swatch-color").on("click", function (e) {
		...
		if (color == "blue") {
			...
			$(".product_2 .product-featured-image").attr(
				"src",
				"assets/images/product/product_8.jpg"
			);
		} else {
		...
		if (color == "purple") {
			...
			$(".product_2 .product-featured-image").attr(
				"src",
				"assets/images/product/product_7.jpg"
			);
		} else {
	...
	$(".product-info .color_selector > .swatch-color").on("click", function (e) {
		...
		if (color == "blue") {
			...
			$(".product_selector_1").attr(
				"src",
				"assets/images/product_single/product_single_6.jpg"
			);
		} else {
		...
		if (color == "green") {
			...
			$(".product_selector_1").attr(
				"src",
				"assets/images/product_single/product_single_2.jpg"
			);
		} else {
		...
		if (color == "purple") {
			...
			$(".product_selector_1").attr(
				"src",
				"assets/images/product_single/product_single_3.jpg"
			);
		} else {
		...
		if (color == "orange") {
			...
			$(".product_selector_1").attr(
				"src",
				"assets/images/product_single/product_single_5.jpg"
			);
		} else {
		...
		if (color == "red") {
			...
			$(".product_selector_1").attr(
				"src",
				"assets/images/product_single/product_single_4.jpg"
			);
		} else {
